...
export class ChatService {
	...
	private participantsComponent: MatSidenav;
	...
	setParticipantComponent(ParticipantSidenav: MatSidenav) {
		this.participantsComponent = ParticipantSidenav;
	}
	...
	toggleParticipants(){
		...
		this.participantsComponent.toggle();
	}
